...
<html lang="ja">
<head>
<title>10 Questions | by よしおかさんち</title>
...
#answer span:first-child:before {
  content:"they can't do their homework";
}
#answer span:first-child label:after {
  content:"宿題できないんだよ";
}
#answer span:last-child:before {
  content:"they don't even understand it";
}
...
<div class="question">
<h2>How do you teach children who don't know numbers a conception of numbers?</h2>
<p>数を知らないこどもに数の概念を伝えるには？</p>
